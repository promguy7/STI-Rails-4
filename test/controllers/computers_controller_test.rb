...
class ComputersControllerTest < ActionController::TestCase
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post :create, computer: { manufacturer: @computer.manufacturer, name: @computer.name, owner: @computer.owner, type: @computer.type }
    end
  ...
  test "should update computer" do
    patch :update, id: @computer, computer: { manufacturer: @computer.manufacturer, name: @computer.name, owner: @computer.owner, type: @computer.type }
    assert_redirected_to computer_path(assigns(:computer))
  end
